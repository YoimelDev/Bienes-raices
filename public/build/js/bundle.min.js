function darkMode(){const e=document.querySelector(".dark-mode-boton"),n=window.matchMedia("(prefers-color-scheme: dark)");console.log(n.matches),n.matches?document.body.classList.add("dark-mode"):document.body.classList.remove("dark-mode"),n.addEventListener("change",()=>{n.matches?document.body.classList.add("dark-mode"):document.body.classList.remove("dark-mode")}),e.addEventListener("click",()=>{document.body.classList.toggle("dark-mode")})}function eventListeners(){document.querySelector(".mobile-menu").addEventListener("click",navegacionResponsive);document.querySelectorAll('input[name="contacto[contacto]"]').forEach(e=>e.addEventListener("click",mostrarMetodosContacto))}function navegacionResponsive(){document.querySelector(".navegacion").classList.toggle("mostrar")}function mostrarMetodosContacto(e){const n=document.querySelector("#contacto");"telefono"===e.target.value?n.innerHTML='\n            <label for="telefono">Numero Telefono</label>\n            <input data-cy="input-telefono" id="telefono" type="tel" placeholder="Tu Telefono" name="contacto[telefono]" />\n\n            <p>Elija la fecha y la hora para la llamada</p>\n\n            <label for="fecha">Fecha:</label>\n            <input data-cy="input-fecha" id="fecha" type="date" name="contacto[fecha]" />\n\n            <label for="hora">Hora:</label>\n            <input data-cy="input-hora" id="hora" type="time" min="09:00" max="18:00" name="contacto[hora]" />\n        ':n.innerHTML='\n            <label for="email">E-mail</label>\n            <input data-cy="input-email" id="email" type="email" placeholder="Tu Email" name="contacto[email]" required />   \n        '}
